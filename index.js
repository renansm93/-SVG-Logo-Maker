...
function init() {
  inquirer
    ...
    .then((answers) => { 
      ...
      let wshapeBackgroundColor = answers.shapeBackgroundColor.toLowerCase();
      ...
      if (answers.text == "") {
        ...
        init();
          ...
          init();      
      } else if  (!isCss3Color(wshapeBackgroundColor)) {
          console.log("Please enter a valid css color keyword or hex code for shape background");
          init();
      } else {
